...
// Independent users are configured through CONTRAIL_RELAY_USERS in a .env file.
...
function printUsers(envFile, env, users) {
  ...
  if (env[LEGACY_TOKEN_KEY]) console.log('[relay-user] Legacy default token: configured');
  if (!users.size) {
...
function printHelp() {
  console.log(`Contrail relay user helper
