...
// CONTRAIL_RELAY_AUTH_MODE=sqlite-fallback or sqlite. Tokens are printed only
...
function printHelp() {
  console.log(`Contrail SQLite relay user helper

Usage:
  npm run relay:db:user -- list [--db path/to/contrail.db]
  npm run relay:db:user -- add <user_id> [--name "Display Name"] [--token token] [--db path/to/contrail.db]
  npm run relay:db:user -- rotate <user_id> [--token token] [--db path/to/contrail.db]
  npm run relay:db:user -- revoke <user_id> [--db path/to/contrail.db]
  npm run relay:db:user -- disable <user_id> [--db path/to/contrail.db]
  npm run relay:db:user -- enable <user_id> [--db path/to/contrail.db]
  npm run relay:db:user -- delete <user_id> [--db path/to/contrail.db]
  npm run relay:db:user -- backup [output.db] [--db path/to/contrail.db]
